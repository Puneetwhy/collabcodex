...
const Home = () => {
  ...
  return (
    <div className="min-h-screen text-foreground overflow-x-hidden relative bg-white bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px]">
      ...
      <section className="relative py-16 sm:py-20 md:py-32">
        <div className="container mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="mb-14">
            ...
            <span className="md:text-xl lg:text-2xl sm:text-xl font-semibold">
              Real-Time <span className='text-red-700'>Collaborative</span> Cloud IDE
            </span>
          </div>

          {/* Description */}
          <p className="text-base md:text-xl text-gray-700 font-light text-muted-foreground max-w-3xl mx-auto mb-16 px-2">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            {howItWorks.map((step, idx) => (
              <div key={idx} className="flex flex-col items-center text-gray-700 text-center px-4 transition-transform duration-300 hover:-translate-y-2">
                ...
                <div className="mb-4 p-4 bg-primary/10 rounded-full shadow-inner text-primary text-2xl sm:text-3xl">{step.icon}</div>
          ...
          <div className="text-center mt-12 sm:mt-16">
            <Button size="lg" className="h-12 sm:h-14 px-8 sm:px-10 text-base sm:text-lg w-full sm:w-auto bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white shadow-md hover:shadow-xl hover:brightness-110 transition-all duration-300" asChild>
      ...
      {/* Footer */}
      <footer className="border-t border-border py-16 bg-blur-10% shadow-gray-700">
        <div className="container mx-auto px-4 sm:px-6">
